...
public class DateUtils {
     ...
     * @return String
     */
    public static synchronized String dateFormat( Date o ) {
        if (o == null) {
            return "";
        }
     ...
     * @return String
     */
    public static synchronized String dateTimeFormat( Date o ) {
        if (o == null) {
            return "";
        }
     ...
     * @throws ParseException
     */
    public static synchronized Date fDate( Date dat ) throws ParseException {
     ...
     * @return String
     */
    public static synchronized String getEndTime( String start, int span ) {
     ...
     * @throws ParseException
     */
    public static synchronized String getFormatStringDay( String str ) throws ParseException {
